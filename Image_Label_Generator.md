...
My first project I turned into Terraform was a huge success for me, and it wasn't that complicated once I figured everything out. I learned a lot more about resource, data, and output blocks from this project. I was really trying to imitate the Hashicorp tutorial in creating it, but once I dug in I found that I didn'y need to imitate it that much. I was really shocked that it didn't take that much effor to build an s3 bucket using Terraform as the method and I was just as equally surprised when I learned that I could just upload that image I needed to the bucket using the same resource block.

The real tricky part was getting the bucket name into the python code, since it was auto-generated by terraform. I did a little research and had AI walk me few a few of my options and I found that putting the bucket name in an output block, then defining the output as an environment variable in terminal to then be imported into the python file using the os library was the most effective. I hadn't messed with environment variables much since this project and it wasn't as bad or confusing as I thought they would be. All in all I am super happy with how this turned out and I am looking forward to making more terraform files of my projects.